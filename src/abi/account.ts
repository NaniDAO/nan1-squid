...
export const functions = {
	addDeposit: new Func<[], {}, []>(abi, "0x4a58db19"),
	...
	completeOwnershipHandover: new Func<
		...
		[]
	>(abi, "0xf04e283e"),
	delegateExecute: new Func<
		[delegate: string, data: string],
		{ delegate: string; data: string },
		string
	>(abi, "0xb10cc728"),
	eip712Domain: new Func<
		[],
		{},
		[
			fields: string,
	...
	>(abi, "0x84b0196e"),
	entryPoint: new Func<[], {}, string>(abi, "0xb0d691fe"),
	execute: new Func<
		[target: string, value: bigint, data: string],
		{ target: string; value: bigint; data: string },
		string
	>(abi, "0xb61d27f6"),
	executeBatch: new Func<
		[
			calls: Array<
				[target: string, value: bigint, data: string] & {
					target: string;
		...
		Array<string>
	>(abi, "0x34fcd5be"),
	getDeposit: new Func<[], {}, bigint>(abi, "0xc399ec88"),
	initialize: new Func<[newOwner: string], { newOwner: string }, []>(
		abi,
		"0xc4d66de8",
	),
	isValidSignature: new Func<
	...
	ownershipHandoverExpiresAt: new Func<
		...
		bigint
	>(abi, "0xfee81cf4"),
	proxiableUUID: new Func<[], {}, string>(abi, "0x52d1902d"),
	...
	storageStore: new Func<
		[storageSlot: string, storageValue: string],
		{ storageSlot: string; storageValue: string },
		[]
	>(abi, "0x125b14e5"),
	...
	upgradeTo: new Func<
		...
		[]
	>(abi, "0x3659cfe6"),
	upgradeToAndCall: new Func<
		[newImplementation: string, data: string],
		{ newImplementation: string; data: string },
		[]
	>(abi, "0x4f1ef286"),
	validateUserOp: new Func<
		[
			userOp: [
				sender: string,
				nonce: bigint,
